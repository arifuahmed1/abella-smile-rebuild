        ...
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center space-x-4 mb-8">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-gray-600">Based on 60+ reviews</p>
            </div>
          </div>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {testimonials.map((testimonial, index) => <Card key={index} className="bg-white hover:shadow-lg transition-shadow duration-300 border-0 shadow-md">
